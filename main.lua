...
local button_a = button("BUTTON",100,100,110,40)
...
ui_box_a:add_component(label_a):set_draw_box(true)
ui_box_a:add_component(button_a)
ui_box_a:add_component(input_a)
ui_box_a:add_component(slide_a)
ui_box_a:add_component(window_a)
window_a:add_component(button("HELLO",10,100,100,35):set_drag(true))
window_a:add_component(button("LING",120,100,100,35))
window_a:add_component(button("中文",120,500,100,35))
