...
Gspot.group = {
	load = function(this, Gspot, label, pos, parent)
		return Gspot:element('group', label, pos, parent)--original: Gspot:add(Gspot:element('group', label, pos, parent))
	end,
...
Gspot.text = {
	load = function(this, Gspot, label, pos, parent, autosize)
		...
		return element --original : Gspot:add(element)
	end,
	setfont = function(this, font, size)
...
Gspot.button = {
	load = function(this, Gspot, label, pos, parent, autosize)
		...
		return Gspot:element('button', label, pos, parent)--original : Gspot:add(Gspot:element('button', label, pos, parent))
	end,
	draw = function(this, pos)
...
Gspot.radius = {
	load = function(this, Gspot, label, pos, parent)
		return Gspot:element('radius', label, pos, parent)--original:Gspot:add(Gspot:element('radius', label, pos, parent))
	end,
	draw = function(this, pos)
		--
	end,
